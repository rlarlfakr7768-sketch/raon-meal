...
USER_TMPL = (
    "아래 과학뉴스 후보에서 가장 흥미롭고 정확하며 학생에게 적절한 1건을 골라 JSON으로:\n"
    "- headline: 한국어 헤드라인(낚시·과장 금지)\n"
    "- summary: 한국어 5~7문장으로 충분히 자세하게. "
    "단순 사실 나열이 아니라 '왜 중요한지', '어떤 원리인지', '맥락'까지 풀어서 설명해 "
    "고등학생이 배경지식 없이도 이해하도록 해라. "
    "단, 모든 문장은 원문 표현·구조를 따르지 말고 네 말로 완전히 새로 쓰고, "
    "기사에 없는 수치·인용·해석은 절대 추가하지 마라(불확실하면 생략).\n"
    "- source, link: 후보 값 그대로\n"
    "- photo_query: 관련 영어 스톡사진 검색어(2~4단어)\n"
    'JSON만: {"headline":"","summary":"","source":"","link":"","photo_query":""}\n\n'
    "후보:\n{items}"
)

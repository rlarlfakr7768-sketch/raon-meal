...
USER_TMPL = (
    ...
    "3) 한국어 본문을 '네 말로 새로' 충실하고 길게 쓴다(4~6문장, 320~520자). 배경 → 무엇을 발견·발표했는지 → 어떻게 → 왜 중요한지를 학생이 이해하게 자세히 설명하라. 단 원문 기사를 번역·복붙·부분수정 하지 말고, 제공된 정보와 널리 확립된 과학 상식 범위에서 쓰되 확인 안 된 구체 수치·인용은 지어내지 마라.\n"
